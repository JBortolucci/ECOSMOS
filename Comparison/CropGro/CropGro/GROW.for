...
C-----------------------------------------------------------------------
      ! print*,  WLDOTN, SLDOT, WLIDOT, WLFDOT, NRUSLF, CRUSLF

      WLDOT = WLDOTN - SLDOT - WLIDOT - WLFDOT - NRUSLF/0.16 - CRUSLF

      ! print *, WLDOT , WLDOTN , SLDOT , WLIDOT , WLFDOT , NRUSLF, CRUSLF
...
C     Convert from g/m2 to kg/ha with a factor of 10.note
