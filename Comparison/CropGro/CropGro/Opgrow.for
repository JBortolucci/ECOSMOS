...
!-----------------------------------------------------------------------
       OPEN(585,FILE='INTEGRACAO_CONTROLE.OUT',STATUS='UNKNOWN')
       OPEN(583,FILE='TGRO.OUT',STATUS='UNKNOWN')
       OPEN(584,FILE='VARAUX.OUT',STATUS='UNKNOWN')
       write(584,*)"DAS",'           ',"PAR",'           ',"PG",'           ',"AGEFAC",'           ',"MAINR",'           ',"EOP","           ","RO","           ","RP","           ","TRWUP","           ","TURFAC","           ","SWFAC","           ","CMINEP", "           ", "TAVG"
       OPEN(586,FILE='PGAVL.OUT',STATUS='UNKNOWN')
       write(586,*)"PGAVL"
       OPEN(590,FILE='ST.OUT',STATUS='UNKNOWN')
       OPEN(591,FILE='SW.OUT',STATUS='UNKNOWN')
       OPEN(592,FILE='NO3.OUT',STATUS='UNKNOWN')
       OPEN(593,FILE='NH4.OUT',STATUS='UNKNOWN')
       OPEN(594,FILE='NAVL.OUT',STATUS='UNKNOWN')
       OPEN(595,FILE='PROG.OUT',STATUS='UNKNOWN')
       OPEN(596,FILE='FT.OUT',STATUS='UNKNOWN')
       OPEN(597,FILE='FUDAY.OUT',STATUS='UNKNOWN')
       OPEN(598,FILE='FSW.OUT',STATUS='UNKNOWN')
       OPEN(599,FILE='FNSTR.OUT',STATUS='UNKNOWN')
       OPEN(600,FILE='FPSTR.OUT',STATUS='UNKNOWN')
       OPEN(601,FILE='REM.OUT',STATUS='UNKNOWN')
       write(594,*)"NAVL"
