...
c
     ...
     >           dsat6 =  7.1310977e-12 )
c
c statement functions tsatl,tsati are used below so that lowes
c polyomial for liquid is used if t gt 273.16, or for ice if 
c t lt 273.16. also impose range of validity for lowes polys.
c
...
c (100 * lowes poly since 1 mb = 100 n/m**2.)
c
      esat (t) = 
     >  100.*(
