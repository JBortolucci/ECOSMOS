...
c
      ...
      character*40 file_wth_RH,file_wth_U2
...
c	data ndaypm /31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31/
	...
	if(lat_npoi(i).gt.0.0.and.lat_npoi(i).le.-10.0)then
     ...
     > //lonc7(1:3)//lonc7(5:7)//latc6(1:2)//latc6(4:6)//'.csv'
	  file_wth_RH='Xavier_RH_'
     > //lonc7(1:3)//lonc7(5:7)//latc6(1:2)//latc6(4:6)//'.csv'
	  file_wth_U2='Xavier_u2_'
     > //lonc7(1:3)//lonc7(5:7)//latc6(1:2)//latc6(4:6)//'.csv'
	...
	filen='input_xavier/'//file_wth_RH
        open (36,file=filen,status='old')
	filen='input_xavier/'//file_wth_U2
        open (37,file=filen,status='old')
...
c mydate;year;month;day;var
           ...
           read(36,*)metdate,metyear,inm,ind,invar5 
           read(37,*)metdate,metyear,inm,ind,invar6 
	...
	insrad(i,ind,inm,(metyear-1979))=invar4
	  inrh(i,ind,inm,(metyear-1979))=invar5
	  inu2(i,ind,inm,(metyear-1979))=invar6
...
c	stinrad(i)   = -9999
	stinqd(i)    = inrh(i,iday,imonth,anov)
	stinwindd(i) = inu2(i,iday,imonth,anov)
