...
c
      ...
      real rhovegvu, tauvegvu, rhovegiru, tauvegiru, rhovegvlg, rhovegvlb
      real tauvegvlg, tauvegvlb, rhovegirlb, rhovegirlg, tauvegirlg, tauvegirlb
c
      real otmp(npoi)
c
      parameter (ntmu=100)
