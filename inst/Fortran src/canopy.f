...
csant	if(i.eq.1)print*,u1(i),u12(i),u34(i)  
	...
	use(3,8) = use(3,8) + 41.4 *  cl(i)/rhoa(i)
        ...
        write(227,133)jday,lai(i,1)*fl(i),use(3,1)/24.,use(3,2)/24.
     >,use(3,3)/24.,use(3,4)/24.,use(3,5)/24.,use(3,6)/24.,use(3,7)/24.,use(3,8)/24.

 133	format(i3,9(1x,f8.2))
	use(3,1) = 0. 
	use(3,2) = 0. 
	use(3,3) = 0. 
	use(3,4) = 0. 
...
c
      integer i, k
c
      real rwork, zwtot, rwork2, tgav, tiav, tuav, e,  
...
c
      integer i
c
      real p, q, tak, ta, twk, twold, diff
c
      include 'comsat.h'
c
