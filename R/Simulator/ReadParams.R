...
ReadPlantParamsFromFile <- function(path = "") {
  ...
  for(simId in ls(simInstances)) {
    ...
    for(i in 1:npft) {  
      ...
      envToSet$drought[indexOfPlant] <-as.numeric(data[28,column])
      envToSet$f1[indexOfPlant] <-as.numeric(data[29,column])
      envToSet$f2[indexOfPlant] <-as.numeric(data[30,column])
      envToSet$baset[indexOfPlant] <- as.numeric(data[31,column])
      envToSet$mxtmp[indexOfPlant] <-as.numeric(data[32,column])
      envToSet$tkill[indexOfPlant] <-as.numeric(data[33,column])
      envToSet$laicons[indexOfPlant] <-as.numeric(data[34,column])
      envToSet$allconsl[indexOfPlant] <-as.numeric(data[35,column])
      envToSet$allconss[indexOfPlant] <-as.numeric(data[36,column])
      envToSet$laimx[indexOfPlant] <-as.numeric(data[37,column])
      envToSet$arooti[indexOfPlant] <-as.numeric(data[38,column])
      envToSet$arootf[indexOfPlant] <- as.numeric(data[39,column])
      envToSet$aleaff[indexOfPlant] <-as.numeric(data[40,column])
      envToSet$astemf[indexOfPlant] <-as.numeric(data[41,column])
      envToSet$declfact[indexOfPlant] <-as.numeric(data[42,column])
      envToSet$fleafi[indexOfPlant] <-as.numeric(data[43,column])
      envToSet$ptemp[indexOfPlant] <-as.numeric(data[44,column])
      envToSet$pmintemp[indexOfPlant] <-as.numeric(data[45,column])
      ...
      envToSet$pcm[indexOfPlant] <- as.numeric(data[48,column])
      envToSet$pcd[indexOfPlant] <- as.numeric(data[49,column])
      envToSet$hybgdd[indexOfPlant] <-as.numeric(data[50,column])
      envToSet$gddmin[indexOfPlant] <-as.numeric(data[51,column])
      envToSet$mxgddgf[indexOfPlant] <-as.numeric(data[52,column])
      envToSet$mxdgfi[indexOfPlant] <-as.numeric(data[53,column])
      
      # O mxmat é igual o período máximo do ciclo.
      envToSet$mxmat[indexOfPlant] <- cycleLength  # as.numeric(data[54,column])
      
      envToSet$lfemerg[indexOfPlant] <-as.numeric(data[55,column])
      envToSet$grnfill[indexOfPlant] <-as.numeric(data[56,column])
      envToSet$bfact[indexOfPlant] <-as.numeric(data[57,column])
      envToSet$ztopmxPft[indexOfPlant] <-as.numeric(data[58,column])
      envToSet$cgrain[indexOfPlant] <- as.numeric(data[59,column])
      envToSet$convfact[indexOfPlant] <- as.numeric(data[60,column])
      envToSet$maxhi[indexOfPlant] <-as.numeric(data[61,column])
      envToSet$fyield[indexOfPlant] <-as.numeric(data[62,column])
      envToSet$cfrac[indexOfPlant] <-as.numeric(data[63,column])
      envToSet$fnlfmx[indexOfPlant] <-as.numeric(data[64,column])
      envToSet$fngrmx[indexOfPlant] <-as.numeric(data[65,column])
      envToSet$sratio[indexOfPlant] <-as.numeric(data[66,column])
      envToSet$rratio[indexOfPlant] <-as.numeric(data[67,column])
      envToSet$fnopt[indexOfPlant] <- as.numeric(data[68,column])
      envToSet$fngrain[indexOfPlant] <- as.numeric(data[69,column])
