...
source("D:\Embrapa\2020\ECOSMOS\ECOSMOS\R\CropModels\Soybean\GROW.R")
source("D:\Embrapa\2020\ECOSMOS\ECOSMOS\R\CropModels\Soybean\ROOTS.R")
...
GROWTH <- function (iyear, iyear0, jday,DAS,DYNAMIC){
  ...
  # TODO:CONTROL, ISWITCH, EMERG, SOILPROP, 
  GROW (DYNAMIC, EMERG, 
  ...
  ROOTS (DINAMYC, #DINAMYC no original
