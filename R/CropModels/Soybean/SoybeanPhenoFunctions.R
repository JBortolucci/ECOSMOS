#=======================================================================
#   RSTAGES Subroutine from CROPGRO/DSSAT
#  Written by J.W. Jones, K.J. Boote, G. Hoogenboom
#  Calculates phenological stages and individual phase durations.
#======================================================================
  


RSTAGES <- function (CONTROL,FNSTR, FPSTR, FSW, FT, FUDAY, ISIMI, NPRIOR,    #Input
                      PHTHRS, PLME, SDEPTH, YRDOY, YRPLT, YRSIM) {
#R C=======================================================================
#R !  RSTAGES Subroutine Modified from
#R C      STAGES, Subroutine, J. W. Jones
#R C  Calculates phenological stages and individual phase durations.
#R C-----------------------------------------------------------------------
#R   C  REVISION HISTORY
#R C  01/01/1993 Written J.W. Jones, K.J. Boote, G. Hoogenboom
#R !  08/../1997 CHP modified for CROPGRO restructuring
#R C  03/24/2004 CHP Calculate SeedFrac for P partitioning (Bostick model)
...
#R C=======================================================================
#R   
#R   SUBROUTINE RSTAGES(CONTROL,
#R                      &    FNSTR, FPSTR, FSW, FT, FUDAY, ISIMI, NPRIOR,    !Input
#R                      &    PHTHRS, PLME, SDEPTH, YRDOY, YRPLT, YRSIM,      !Input
#R                      &    JPEND, MDATE, NDLEAF, NDSET, NDVST, NVALPH,     !Output
#R                      &    NVEG0, NVEG1, NR1, NR2, NR5, NR7, PHZACC,       !Output
#R                      &    RSTAGE, STGDOY, SeedFrac, VegFrac, YREMRG,      !Output
#R                      &    YRNR1, YRNR2, YRNR3, YRNR5, YRNR7)              !Output
#R 
#R  !-----------------------------------------------------------------------
#R    USE ModuleDefs     !Definitions of constructed variable types, 
...
#R  INTEGER NDLEAF,  NDSET, NDVST, JPEND  !, TIMDIF
...
#R  !       for chickpea.  Will have to investigate why!!! chp 05/13/2004
...
#R  TYPE (ControlType) CONTROL
#R  DYNAMIC = CONTROL % DYNAMIC
  DAS     = CONTROL % DAS       #To do
