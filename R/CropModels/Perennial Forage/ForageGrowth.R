...
GROW <- function (DYNAMIC,iyear,jday, ISWNIT,ISWSYM)  {
  ...
  # TODO: Leandro 22/10/2020
  # IPGROW - Novos Parâmetros
  # TNCFAC
  # SENCLV, SENCRV, SENCSV, SENCSRV,
  # SENNLV, SENNRV, SENNSV, SENNSRV,
  # ALPHSR, PCARSR, PCHOLFF, PCHORTF, PCHOSRF, PCHOSTF,
  ...
  if (DYNAMIC == 'SEASINIT') {
    ...
    RHOSH  = 0.0
    RTWT   = 0.0
    # SDRATE = 0.0 #TODO: Leandro - Remover (21/10/2020)
    SDWT   = 0.0
    SDWTAM = 0.0
    SEEDNI = 0.0
    SEEDNO = 0.0
    ...
    # simDataVars$SENESCE_CumResE   <-  c() #TODO: Leandro - Remover (21/10/2020)
    ...
    # ShutMob = 0.0     #TODO: Leandro - Remover (21/10/2020) 
    # RootMob = 0.0     #TODO: Leandro - Remover (21/10/2020)
    # ShelMob = 0.0     #TODO: Leandro - Remover (21/10/2020)
    
    SDPDOT = 0.0    #CHP - not used
    PUNDOT = 0.0    #CHP - not used
    
    # NLPEST = 0.0    #CHP - N loss due to pest damage  #TODO: Leandro - Remover (21/10/2020)
    ...
    # WLDOT = WLDOTN - SLDOT - WLIDOT - WLFDOT - NRUSLF/0.16 - CRUSLF  #TODO: Leandro - Remover (21/10/2020)
    ...
    #     ShutMob is amount of leaf mass lost due to N and C mobilization    #TODO: Leandro - Remover (21/10/2020) 
    #     A positive value represents leaf mass lost. (kg/ha)                #TODO: Leandro - Remover (21/10/2020) 
    # ShutMob = (NRUSLF/0.16 + CRUSLF) * 10.      #kg/ha                     #TODO: Leandro - Remover (21/10/2020) 
    ...
    # ShelMob = (NRUSSH / 0.16 + CRUSSH) * 10.    #kg/ha       #TODO: Leandro - Remover (21/10/2020) 
...
ROOTS <- function(DYNAMIC,CROP,  ISWWAT) { #TODO Santiago
  ...
  # TODO: Leandro 23/10/2020
  # IPROOT - Novos Parâmetros
  # PLME, PLTPOP,
  # RTEXF, RTSEN,
...
DEMAND <- function(DYNAMIC, DAS, CROP, PAR, PGAVL,RPROAV, TAVG) {
  ...
  # TODO: Leandro 23/10/2020
  # IPDMND - Novos Parâmetros
  # YSTEST, YLFEST, YSLATM, SDLEST, FRSTRF, FRSTRMX, LRMOB, 
  # NMOBSRN, NMOBSRX, NRMOB, PLME, PROLFR, PRORTR, PROSRF, 
  # PROSRI, PROSRR, PROSTR, SDAGPL, TYPLMOB, 
  # TYPNMOB, YSREST, YSTOR, KCOLD
  ...
  if (DYNAMIC == 'SEASINIT') {
    ...
    # TODO: Busca o Valor NSLA nos Parâmetros  Leandro 22/10/2020
...
VEGGR <- function(DYNAMIC,DAS,iyear,jday, CMINEP, CSAVEV, NAVL, PAR, PG, PGAVL) {                 
  ...
  if (DYNAMIC == 'SEASINIT') {
    ...
    # CANOPY(DYNAMIC,DAS, PAR, TGRO)         # TODO: Remover!!  Laandro 22/10/2020
    ...
    if (NLEAK > 0.0) {
      # TODO: Verificar Parâmetros da função e verificar a variável NLEAK!  Leandro 22/10/2020
      #    CALL NLKDIST(
